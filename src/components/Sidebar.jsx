...
export default function Sidebar({ isSidebarOpen }) {
  ...
  return (
    <div className={`col-md-2 p-0 transition-all rounded-end-5 ${isSidebarOpen ? 'show' : 'collapse'}`} id="sidebar" style={{
